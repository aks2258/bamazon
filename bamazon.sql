--Drops the database if it previously exists and creates databse.
DROP DATABASE IF EXISTS bamazon_DB;
CREATE DATABASE bamazon_DB;

--Uses created database in application
USE bamazon_DB;

CREATE TABLE bamazon(
  id INT NOT NULL AUTO_INCREMENT,
  product_name VARCHAR(100) NOT NULL, --NOT NULL does not allow an empty values
...
--Displays everything from the bamazon table and displays it
SELECT * FROM bamazon;

--Inserts items and their corresponding department, price and quantity into the bamazon table.
